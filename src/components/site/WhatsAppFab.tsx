...
export const WhatsAppFab = () => {
  ...
  return (
    <a
      href="https://wa.me/40751577948?text=Salut%20Pixel%20%26%20Profit!"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contact pe WhatsApp"
      className={`fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full btn-metal-dark shadow-glow flex items-center justify-center bubble-hover transition-all duration-500 ${
